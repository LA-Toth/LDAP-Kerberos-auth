...
%    DEBUG[load\_index]: unique\_subject = "yes"\\
  ...
  \ut{dev-libs/cyrus-sasl\\
   ...
   \ut{\# /etc/amavisd.conf\\
     ...
     \$virus_admin = "panther@\$mydomain";
     \$mail_notify_admin = "antivirus@\$mydomain";
     \$mail_notify_spamadmin = "antivirus@\$mydomain";
     \# \#\#\# http://www.clamav.net/
	['ClamAV-clamd',
	  \textbackslash\&ask_daemon, ["CONTSCAN \{\}\textbackslash n", "/var/run/clamav/clamd.sock"],
   ...
   A \texttt{mail_notify*} a levelek feladója, ha értesítést küld a rendszer, hogy spamet vagy mást talált.
   ...
   \ut{export KRB5_KTNAME=/etc/krb5.keytab.ldap}
