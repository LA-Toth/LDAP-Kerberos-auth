...
A dokumentumban ismertetett rendszer egyik központi része az OpenLDAP szerver, amely az \textsc{ldap} protokollt ({\em Lightweight
...
Az \textsc{ldap} egy hierarchikusan (faszerkezetbe) szervezett adatbázis elérésére szolgáló protokoll. A fában tárolt adatokat
