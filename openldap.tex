\chapter{Az LDAP és az OpenLDAP kiszolgáló}
...
A \texttt{BASE} után a faszerkezet valamely csúcsának egyedi nevét kell megadni, amely alatti bejegyzéseken történik a
...
\item Lehet törölni is egy attribútumot, például:
...
\item Ha egy adott attribútumot (amiből több különböző értékű is lehet) kellene, akkor:
...
\item A teljes bejegyzés törlése:
